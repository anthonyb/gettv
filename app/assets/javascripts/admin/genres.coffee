...
@Character.Settings.GenresLayout = Character.Settings.DetailsLayout.extend
  newItem: ->
...
chr.settingsGenres = (titleMenu = 'Genres') ->
  chr.settingsModule 'Genres',
    titleMenu: titleMenu
    detailsViewClass: Character.Settings.GenresLayout